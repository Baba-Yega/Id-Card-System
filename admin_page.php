...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if (isset( $_POST['snoEdit'])){
      // Update the record
        $sno = $_POST["snoEdit"];
        $name = $_POST["nameEdit"];
        $mat_no = $_POST["mat_noEdit"];

      // Sql query to be executed
      $sql = "UPDATE `cards` SET `name` = '$name' , `mat_no` = '$mat_no' WHERE `cards`.`sno` = $sno";
      $result = mysqli_query($conn, $sql);
      if($result){
        $update = true;
    }
    ...
    if($name == '' || $mat_no == ''){
        ...
        $querry = mysqli_query($conn, "SELECT * FROM cards WHERE mat_no= '$mat_no' ");
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`name`, `mat_no`, `email`, `phone`, `student`, `dob`, `exp_date`, `image`) VALUES ('$name','$id_no','$email]','$phone','$student','$dob','$exp_date','$uploadfile')"; 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Edit This Student ID</h5>
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="mat_noEdit" name="mat_noEdit" rows="3"></input>
            </div> 
          </div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="admin_page.php">Admin</span></a>
      </li>
      <li class="nav-item">
...
<!-- Navigation bar end  -->
  ...
  <i class="fa fa-plus"></i> Add New Student ID
  </button>
  <a href="id-card.php" class="btn btn-primary">
  <i class="fa fa-address-card"></i> Verify Student ID
</a>
</p>
